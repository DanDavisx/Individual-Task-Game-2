...
def filter_words(words, skip_words):
    ...
    #  return the word entered if it is not in the skip_words list
...
def remove_punct(text):
    ...
    do = text.translate(punc_remover)
    # ^ maketrans used with translate to swap specified characters
    return do
...
def normalise_input(user_input):
    ...
    """
    no_punct = remove_punct(user_input).lower()  # the same as exercise 4
    input_list = no_punct.split()
    filter_list = filter_words(input_list, skip_words)
    return filter_list
